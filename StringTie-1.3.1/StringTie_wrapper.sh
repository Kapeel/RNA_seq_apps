...
if [ "${enable_bgwn}" = 1 ]; then runthis="$runthis -B"; mkdir ballgown_input_files; fi
if [ "${ref_gtf}" = 1 ]; then runthis="$runthis -e"; fi
...
rm -rf stringtie-1.3.1c.Linux_x86_64 StringTie_wrapper.sh
