...
tar -xvf SOAPdenovo-Trans-bin-v1.03.tar.gz
mkdir soaptrans_bin
mv LICENSE SOAPdenovo-Trans-* update.log VERSION MANUAL soaptrans_bin
chmod a+x ./soaptrans_bin*
export PATH=$PATH:./soaptrans_bin/
...
format1=q
#reads1_1="${reads1_1}"
reads1_1='BA_1.norm.fq'
#reads1_2="${reads1_2}"
reads1_2='BA_2.norm.fq'
#######################
avg_ins2="${avg_ins2}"
#avg_ins2=3000
